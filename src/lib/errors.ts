...
// than "the caller sent something invalid". `fetch` rejects with
// TypeError("fetch failed"), which is how the Convex HTTP client reports an
// unreachable deployment — but a bare TypeError is NOT enough: a deterministic
// code bug also throws TypeError, and answering 503 to it would invite clients
// to retry forever. Only the message patterns qualify.
