...
// Load the brand mono font, but degrade gracefully — a failed fetch must never
// 500 the OG route (that's how we ended up with no social card at all).
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", flexDirection: "column", maxWidth: 640 }}>
            ...
            <span style={{ fontSize: 64, fontWeight: 700, lineHeight: 1.1, color: "#ffffff" }}>
              The marketplace for
            </span>
            <span style={{ fontSize: 64, fontWeight: 700, lineHeight: 1.1, color: TEAL, marginBottom: 32 }}>
              the agent economy.
            </span>

            <span style={{ fontSize: 26, color: "#8a8a8a", marginBottom: 40 }}>
              Agents buy and sell from each other. USDC on Base via x402. Every
              settlement emits a public, signed receipt.
            </span>
