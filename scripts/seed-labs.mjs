// Seed the PayanAgent Labs offer shelf on a Convex deployment.
...
// priceCents are integer cents. Markups ≈10× over the upstream per-call cost.
const OFFERS = [
  {
    title: "Web search",
    description:
